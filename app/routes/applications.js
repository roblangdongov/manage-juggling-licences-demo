    ...
    router.get('/applications', (req, res) => {
        ...
        if(hasFilters) {
            applications = applications.filter(application => {
                ...
                let matchesNumbersOfBalls = true
                ...
                if(_.get(selectedNumberOfBallsFilters, 'length')) {
                    matchesNumbersOfBalls = selectedNumberOfBallsFilters.includes(application.experience.numberOfBalls);
                }
               
                return matchesStatus && matchesNumbersOfBalls
            })
        }
